  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Lottie.asset(
        ...
        height: size,
        fit: BoxFit.contain,
        // Celebrate plays once and stops on the final frame; idle
        // and sad loop. (Loop keeps idle from looking frozen; sad
        // loops so the droop is visible on slower devices.)
